...
<body>
    ...
    <div class="container">
        ...
        <h2><?php echo translate('Quiz Generator'); ?></h2>
        <div class="buttons">
            <button onclick="window.location.href='login.php?lang=<?php echo $lang; ?>'"> <?php echo translate('Log in'); ?> </button>
            <button onclick="window.location.href='register.php?lang=<?php echo $lang; ?>'"> <?php echo translate('Sign up'); ?> </button>
        </div>
    </div>
</body>
</html>
